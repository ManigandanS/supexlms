<%@ Page Language="C#" MasterPageFile="~/LmsAdmin/Admin.Master" AutoEventWireup="true" CodeBehind="CS0103.aspx.cs" Inherits="Lms.LmsWeb.LmsAdmin.Course.CS0103" %>
    ...
    <section id="course-general">
        <div class="col-xs-12">
            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="LessonName">Lesson Name</asp:Label>
