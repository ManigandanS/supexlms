<%@ Page Language="C#" MasterPageFile="~/LmsAdmin/Admin.Master" AutoEventWireup="true" CodeBehind="QZ0103.aspx.cs" Inherits="Lms.LmsWeb.LmsAdmin.Quiz.QZ0103" %>
                                ...
                                <div id="single-select-list">
                                    <div class="input-group" id="single-select-list-1">
                                        <span class="input-group-addon">
                                            <asp:RadioButton ID="SingleSelectRadio1" runat="server" GroupName="SingleSelect" />
                                        </span>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            var questionType = $('#TypeRadio input:checked').val();
